...
class DB_Mysql implements IDataBase{
	...
	/* connect to database */
	public function Connect($dbHost='',$dbUser='',$dbPwd='',$dbName='',$dbCharset='utf8',$tbPrefix=''){
		$this->host=$dbHost;
		...
		$this->linkId=mysql_connect($this->host.':'.SAE_MYSQL_PORT,$this->username,$this->password);
